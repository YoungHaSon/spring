...
public class YogultItemProcessor implements ItemProcessor<CycleVo, List<DailyVo>>{
	...
	public List<DailyVo> process(CycleVo cycleVo) throws Exception {
		...
		//output = cid : 1 pid: 100 day:20190708 cnt : 1
		//output = cid : 1 pid: 100 day:20190715 cnt : 1
		//output = cid : 1 pid: 100 day:20190722 cnt : 1
		//output = cid : 1 pid: 100 day:20190729 cnt : 1
		...
		//cal : 1~31 순차적으로 증가 ed_dt보다 클때 까지
		while(ed_dt.getTime() >= cal.getTimeInMillis()) {
			//요일이 같을 때만 ! dailyVo로 생성!
			//ex) cycleVo.getDay()--> 월요일을 리턴을 한다면  -->20190701,20190708,201907015,20190722,20190729 으로 5번 변환!
