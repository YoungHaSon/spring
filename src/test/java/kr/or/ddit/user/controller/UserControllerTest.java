...
public class UserControllerTest extends ControllerTestEvn {
	...
	/**
	 * Method : userListTest 작성자 : PC13 변경이력 : Method 설명 : 사용자 전체 리스트 테스트
	 * 
	 * @throws Exception
	 */
	...
	public void userListTest() throws Exception {
		...
		logger.debug("♬♪♩ mav.getModelMap().get(\"userList\") : {}", mav.getModelMap().get("userList") );
		
	}

	/**
	 * Method : userPagingListTest 작성자 : PC13 변경이력 : Method 설명 : 사용자 페이징 리스트 테스트
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Method : userPagingListWithoutParameterTest 작성자 : PC13 변경이력 :
	 * 
	 * @throws Exception Method 설명 : 사용자 페이징 리스트 테스트(page, pageSize 파라미터 없이 호출 시
	 *                   PageVo에 설정해둔 getter값이 제대로 오는지!)
	 */
	@Test
	public void userPagingListWithoutParameterTest() throws Exception {
		...
		// PageVo equals, hashCode메서드를 구현해서 객체 간 값 비교
...
//		assertEquals(10, pageVo.getPageSize());
	...
	/**
	 * Method : userTest 작성자 : PC13 변경이력 : Method 설명 : 사용자 상세조회 테스트
	 * 
	 * @throws Exception
	 */
	@Test
