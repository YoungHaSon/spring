...
public class LoginControllerTest extends ControllerTestEvn {

	
	private static final Logger logger = LoggerFactory.getLogger(LoginControllerTest.class);
	/**
	 * Method : loginViewNotLoginedTest 작성자 : PC05 변경이력 : Method 설명 : 접속하지 않은 상황에서
	 * loginView 요청 테스트
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Method : loginViewLoginedTest 작성자 : PC05 변경이력 :
	 * 
	 * @throws Exception Method 설명 : 로그인한 상황에서 로그인 뷰 요청 테스트
	 */
	@Test
	...
	/**
	 * Method : loginProcessSuccessTest 작성자 : PC13 변경이력 :
	 * 
	 * @throws Exception Method 설명 : 로그인 요청 처리 성공 테스트
	 */
	@Test
	public void loginProcessSuccessTest() throws Exception {
		...
		/*** When ***/
		MvcResult mvcResult = mockMvc.perform(post("/login").param("userId", userId).param("password", password))
				.andReturn();
		...
		assertEquals("브라움", userVo.getAlias());

	}

	/**
	 * Method : loginProcessFailTest 작성자 : PC13 변경이력 :
	 * 
	 * @throws Exception Method 설명 : 로그인 요청 처리 실패 테스트
	 */
	@Test
